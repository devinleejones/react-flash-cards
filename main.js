 ...
 */
   ...
   */
          extractEvents: function (topLevelType, targetInst, nativeEvent, nativeEventTarget) {
            ...
            var leaveEventType = void 0

            var enterEventType = void 0

            var eventTypePrefix = void 0
  ...
  */
        ...
        function logCapturedError(capturedError) {
          ...
          var error = capturedError.error
          {
            ...
            var errorBoundaryName = capturedError.errorBoundaryName

            var errorBoundaryFound = capturedError.errorBoundaryFound

            var willRetry = capturedError.willRetry
        ...
        function commitContainer(finishedWork) {
          ...
          switch (finishedWork.tag) {
            ...
            case HostPortal:
            {
              ...
              var _pendingChildren = portalOrRoot.pendingChildren
 ...
 */
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */ var _cardForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cardForm */ './src/cardForm.js')
    /* harmony import */ var _cardList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cardList */ './src/cardList.js')
    /* harmony import */ var _navBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./navBar */ './src/navBar.js')
    /* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cards */ './src/cards.js')
    /* harmony import */ var _hash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hash */ './src/hash.js')
    ...
    /* harmony import */ var _practice__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./practice */ './src/practice.js')
    ...
    class App extends react__WEBPACK_IMPORTED_MODULE_0__['Component'] {
      constructor(props) {
        ...
        const {
          path,
          params
        } = _hash__WEBPACK_IMPORTED_MODULE_5__['default'].parse(location.hash)
        this.state = {
          view: {
            path,
            params
      ...
      handleSubmit(event) {
        ...
        this.setState({
          cards: [{
            ...
            id: uuid_v1__WEBPACK_IMPORTED_MODULE_7___default()().slice(0, 5)
          }, ...this.state.cards]
        })
        event.target.reset()
        location.hash = 'cards'
      ...
      renderView() {
        ...
        switch (path) {
          case 'cards':
            if (cards.length > 0) {
              return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_cardList__WEBPACK_IMPORTED_MODULE_2__['default'], {
                cards: cards,
                deleteCard: deleteCard
              })
            }
            else {
              return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_cards__WEBPACK_IMPORTED_MODULE_4__['default'], null)
            }
          ...
          case 'new':
            ...
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_cardForm__WEBPACK_IMPORTED_MODULE_1__['default'], {
          ...
          case 'edit':
            ...
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_edit__WEBPACK_IMPORTED_MODULE_6__['default'], {
              card: card,
          ...
          case 'practice':
            if (cards.length > 0) {
              return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_practice__WEBPACK_IMPORTED_MODULE_8__['default'], {
                cards: cards
              })
            }
            else {
      ...
      render() {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__['Fragment'], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_navBar__WEBPACK_IMPORTED_MODULE_3__['default'], null), this.renderView())
      }
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    function CardForm(props) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
        ...
        style: styles.title
      }, 'Create a Flash Card'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('form', {
        onSubmit: props.handleSubmit
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
        className: 'form-group m-4 pt-4'
      ...
      }, 'Answer'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', {
        style: styles.input,
        name: 'answer',
        type: 'text',
        id: 'exampleAnswer',
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    function CardList(props) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('h1', {
        style: style.h1,
        className: 'm-4'
      }, 'Card List'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('ul', null, props.cards.map((card, index) => {
        const id = card.id
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('li', {
          ...
          style: style.p
        }, card.question), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('p', {
          style: style.p
        }, card.answer), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('a', {
          style: style.a,
          href: `#edit?cardId=${card.id}`
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    function Cards() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
        ...
        style: styles.text
      }, 'You have no flash cards'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('a', {
        href: '#new',
        style: styles.a
      }, 'Make One'))
    }
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    function Edit(props) {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
        ...
        style: styles.title
      }, 'Edit a Flash Card'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('form', {
        onSubmit: props.updateCard
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
        className: 'form-group m-4 pt-4'
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', {
        name: 'id',
        type: 'hidden',
        defaultValue: props.card.id
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('label', {
        htmlFor: 'exampleQuestion'
      }, 'Question'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', {
        style: styles.input,
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    'use strict'
    __webpack_require__.r(__webpack_exports__)
    /* harmony import */ var _query_string__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./query-string */ './src/query-string.js')
    ...
    const hash = {
      parse(string) {
        ...
        return {
          path: path.slice(1) || '',
          params: _query_string__WEBPACK_IMPORTED_MODULE_0__['default'].parse(query)
        }
      },
      ...
      stringify({
        ...
        return '#' + path + _query_string__WEBPACK_IMPORTED_MODULE_0__['default'].stringify(params)
      }
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    function Navbar() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('nav', {
        ...
        href: '#cards'
      }, 'Cards ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('span', {
        className: 'sr-only'
      }, '(current)')), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('a', {
        className: 'nav-item nav-link ml-2',
        href: '#new'
      }, 'New'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('a', {
        className: 'nav-item nav-link ml-2',
        href: '#practice'
      }, 'Practice'))))
    }
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    class Practice extends react__WEBPACK_IMPORTED_MODULE_0__['Component'] {
      constructor(props) {
        super(props)
        this.state = {
          currentCard: 0,
      ...
      render() {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('div', {
          ...
          style: styles.title
        }, cards[currentCard].question), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('a', null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('i', {
          onClick: this.showAnswer,
          className: 'fas fa-chevron-circle-down',
          style: styles.a
        }), answerButton), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('p', {
          style: styles.p,
          className: `mt-2 ml-1 ${answer}`
        }, cards[currentCard].answer)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('i', {
          style: styles.next,
          onClick: this.changeFlashCard,
          id: 'next',
  ...
  /***/ function (module, __webpack_exports__, __webpack_require__) {
    ...
    const queryString = {
      parse(string) {
        ...
        return string.replace(/^\?/, '').split('&').map(pair => pair.split('=')).reduce((parsed, [key, value]) => Object.assign(parsed, {
          [key]: value
        }), {})
      },
